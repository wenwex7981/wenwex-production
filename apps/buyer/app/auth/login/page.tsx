                ...
                <div className="relative z-10 flex flex-col justify-center p-16 text-white">
                    ...
                    >
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
                            ...
                            <span className="text-sm font-medium">Welcome Back to WENVEX</span>
                        </div>
                        ...
                        <p className="text-xl text-white/80 mb-12 max-w-lg leading-relaxed">
                            Pick up right where you left off. Your projects, favorites, and
                            conversations are waiting for you.
                        </p>
